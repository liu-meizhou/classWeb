	...
	user :=
		web.NewNamespace("/user/v1",
			...
			web.NSNamespace("/student",
				...
				web.NSRouter("/delete", &controllers.StudentController{}, "get:DeleteStudent"),
				web.NSRouter("/editClass", &controllers.StudentController{}, "get:EditClass"),
				web.NSRouter("/list", &controllers.StudentController{}, "post:GetStudentList"),
			...
			web.NSNamespace("/class",
				...
				web.NSRouter("/delete", &controllers.ClassController{}, "get:DeleteClass"),
			...
			web.NSNamespace("/teacher",
				...
				web.NSRouter("/delete", &controllers.TeacherController{}, "get:DeleteTeacher"),
