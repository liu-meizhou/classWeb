	...
	user :=
		web.NewNamespace("/user/v1",
			...
			web.NSNamespace("/course",
				...
				web.NSRouter("/choose", &controllers.CourseController{}, "get:ChooseCourse"),
			...
			//	web.NSRouter("/courses", &controllers.StudentController{}, "get:GetCourses"),
			//),
			//web.NSNamespace("/teacher",
			//	web.NSRouter("/info", &controllers.TeacherController{}, "get,post:TeacherInfo"),
			//	web.NSRouter("/export", &controllers.TeacherController{}, "get:ExportCourse"),
			//	web.NSRouter("/choose", &controllers.TeacherController{}, "get:ChooseCourse"),
			//	web.NSRouter("/grade", &controllers.TeacherController{}, "get,post:CourseGrade"),
			//),
